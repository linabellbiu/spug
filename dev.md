...
```
docker run -d  --name redis   -p 6379:6379   -v ./redis_data:/data   --restart unless-stopped   swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/redis:alpine  redis-server --requirepass admin555 --appendonly yes
```
